...
<tbody>
    ...
    <div class="btn"><label for="check_box"><?php echo L('selected_all');?>/<?php echo L('cancel');?></label>
		...
		<input type="button" class="button" value="批量刷新" onclick="myform.action='?m=content&c=content&a=refresh&catid=<?php echo $catid;?>';myform.submit();"/>
		<input type="button" class="button" value="批量关联" onclick="myform.action='?m=content&c=content&a=inforelate&catid=<?php echo $catid;?>';myform.submit();"/>
		<input type="button" class="button" value="批量更新区域" onclick="myform.action='?m=content&c=content&a=refreshzone&catid=<?php echo $catid;?>';myform.submit();"/>
		<?php }?>
	</div>
